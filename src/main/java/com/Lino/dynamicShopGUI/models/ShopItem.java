...
public class ShopItem {
    ...
    public ShopItem(Material material, String category, double basePrice, double currentPrice,
                    int stock, int minStock, int maxStock, int transactionsBuy, int transactionsSell,
    ...
    public void setStock(int stock) {
        this.stock = Math.max(minStock, Math.min(stock, maxStock));
    }

    public int getMinStock() { return minStock; }
    public int getMaxStock() { return maxStock; }
    public int getTransactionsBuy() { return transactionsBuy; }

    public void incrementTransactionsBuy() {
        this.transactionsBuy++;
    }

    public int getTransactionsSell() { return transactionsSell; }
    ...
    public double getBuyPrice() { return currentPrice; }
    public double getSellPrice() { return currentPrice * 0.7; }
}